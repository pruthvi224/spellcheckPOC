function LiveSpellInstance($setup) {
  livespell.spellingProviders.push(this), this.Fields = "ALL", this.IgnoreAllCaps = !0, this.IgnoreNumeric = !0, this.CaseSensitive = !0, this.CheckGrammar = !0, this.Language = "English (International)", this.MultiDictionary = !1, this.UserInterfaceLanguage = "en", this.CSSTheme = "classic", this.SettingsFile = "default-settings", this.ServerModel = "", this.Delay = 888, this.WindowMode = "modal", this.Strict = !0, this.ShowSummaryScreen = !0, this.ShowMeanings = !0, this.FormToSubmit = "", this.MeaningProvider = "http://www.thefreedictionary.com/{word}", this.UndoLimit = 20, this.HiddenButtons = "", this.CustomOpener = null, this.CustomOpenerClose = null, this.RightClickOnly = !livespell.test.iPhone(), this.ShowLangInContextMenu = !0, this.BypassAuthentication = !1, this.UserSpellingInitiated = !1, this.UserSpellingComplete = !1, this.AddWordsToDictionary = "USER", this.SetUserInterfaceLanguage = function (l) {
    ...
    var oField = document.getElementById(id), TYPE = oField.nodeName.toUpperCase();
    ...
    for (var editedfields = new Array, i = 0; i < fieldIds.length; i++) {
      var id = fieldIds[i], t = this.FieldType(id), oField = document.getElementById(id);
      if (JavaScriptSpellCheck && oField.MessageHolder && JavaScriptSpellCheck.LiveValidateMech(oField), docs[i] !== oField[t]) {
        if (editedfields[editedfields.length] = id, "iframe" === t) {
          var oDoc = livespell.getIframeDocumentBasic(oField), oBody = oDoc.body;
          oBody.innerHTML != docs[i] && (oBody.innerHTML = docs[i])
        } else if (livespell.insitu.proxyDOM(id)) oField[t] = docs[i]; else {
          var val = docs[i];
          oField[t] = val
        }
    ...
    for (var fieldIds = this.arrCleanFields(), i = 0; i < fieldIds.length; i++) {
      var id = fieldIds[i], t = this.FieldType(id);
    ...
    for (var fieldIds = this.arrCleanFields(), docs = [], i = 0; i < fieldIds.length; i++) {
      var val, id = fieldIds[i], oField = document.getElementById(id), t = this.FieldType(id);
      if ("iframe" === t) {
    ...
    var webkit = livespell.test.webkit(), canmodal = !(webkit || this.BypassAuthentication && livespell.test.IE());
    ...
    if ("jquery.ui" == wm.substr(0, 9) && (jQuery, !0) && ($.ui, !0)) {
      ...
      var f = this, u = this.url(), ttl = livespell.lang.fetch(this.id(), "WIN_TITLE"), settings = {
        autoOpen: !0,
        modal: !0,
        closeOnEscape: !0,
        title: ttl,
    ...
    if ("fancybox" == wm && (jQuery, !0)) {
      var uri = this.url(), ttl = livespell.lang.fetch(this.id(), "WIN_TITLE");
    ...
    var strDoc = this.docPickup().join(" "), tokens = livespell.str.tokenize(strDoc), wordlist = [], wasfine = !0;
    livespell.cache.spell[this.Language] || (livespell.cache.spell[this.Language] = []);
    for (var i = 0; i < tokens.length; i++) if (livespell.test.isword(tokens[i]) === !0) {
    ...
    var fResults = this.getFieldWordListMech(), wasfine = fResults.wasfine, wordlist = fResults.wordlist;
    ...
    var F = this.Fields, isString = F.split;
    isString && (F = F.replace(/\s/g, "").split(","));
    for (var out = new Array, j = 0; j < F.length; j++) {
      var AF, i, oid = F[j], found = !1;
      if ("ALL" === oid.toUpperCase() || "ENABLED" === oid.toUpperCase()) for (found = !0, AF = document.body.getElementsByTagName("*"), i = 0; i < AF.length; i++) {
      ...
      if ("TEXTAREAS" === oid.toUpperCase()) for (found = !0, AF = document.getElementsByTagName("textarea"), i = 0; i < AF.length; i++) livespell.insitu.filterTextAreas(AF[i]) && (found = !0, out = livespell.array.safepush(out, AF[i])); else if ("TEXTINPUTS" === oid.toUpperCase()) for (found = !0, AF = document.getElementsByTagName("input"), i = 0; i < AF.length; i++) livespell.insitu.filterTextInputs(AF[i]) && (found = !0, out = livespell.array.safepush(out, AF[i])); else if ("EDITORS" === oid.toUpperCase()) {
      ...
      } else if (E$(oid)) out = livespell.array.safepush(out, E$(oid)), found = !0; else if (document.querySelectorAll) for (var q = document.querySelectorAll(oid), iq = 0; iq < q.length; q++) found = !0, q[iq].id || (q[iq].id = "livespell_css_selected_id_" + i), found = !0, out = livespell.array.safepush(out, q[iq]); else if ("." == oid.charAt(0) && !E$(oid)) {
        var cname = oid.substring(1), AF = livespell.getElementsByClass(cname);
      ...
      if (!found) if (document.getElementById(oid)) {
    ...
    for (var i = 0; i < livespell.spellingProviders.length; i++) if (this === livespell.spellingProviders[i]) return i
    ...
    var holder = document.createElement("span"), o = document.createElement("input");
    ...
    insitu || (insitu = !1), text || (text = "Spell Check"), Class || (Class = ""), style || (style = "");
    var holder = document.createElement("span"), o = document.createElement("a");
    ...
    var holder = document.createElement("span"), o = document.createElement("img");
  ...
  }, this.UniqueIDNetPostBack = "", this.onDialogOpen = function () {
...
function JavaScriptSpellCheckObj($setup) {
  this.DefaultDictionary = "English (International)", this.UserInterfaceTranslation = "en", this.ShowStatisticsScreen = !1, this.SubmitFormById = "", this.Theme = "modern", this.CaseSensitive = !0, this.CheckGrammar = !0, this.IgnoreAllCaps = !0, this.IgnoreNumbers = !0, this.ShowThesaurus = !0, this.ShowLanguagesInContextMenu = !1, this.ServerModel = "auto", this.PopUpStyle = "modal", this.isUniPacked = !0, this.AddWordsToDictionary = "user", this.SpellCheckInWindow = function (Fields) {
    ...
    if (this.ajaxinstance) var o = this.manageAjaxInstance(); else {
    ...
    var j = this, f = Fields, m = MessageHolder, fn = function () {
    ...
    for (var i = 0; i < ff.length; i++) {
      var oneField = ff[i], oField = document.getElementById(oneField);
    ...
    setTimeout(function () {
      ...
      var oneField = Fields.split(",")[0], oField = document.getElementById(oneField),
    ...
    for (var i = 0; i < inputs.length; i++) {
      ...
      for (var j = 0; j < ff.length; j++) {
        var finderItem = ff[j], oObject = null, binWasMacro = !1;
        if ("string" == typeof Fields) {
          var td = Fields, tdcase = Fields.replace(/\s\s*$/, ""), td = Fields.toUpperCase().replace(/\s\s*$/, "");
          "ALL" !== td && "EDITORS" !== td && "TEXTAREAS" !== td && "TEXTINPUTS" !== td || (outputs.push(td), binWasMacro = !0), "." === td.charAt(0) && (outputs.push(tdcase), binWasMacro = !0)
        }
        if (!binWasMacro) if (finderItem.nodeName) oObject = finderItem; else if (finderItem = finderItem.toString().replace(/^\s\s*/, ""), document.getElementById(finderItem)) oObject = document.getElementById(finderItem); else {
    ...
    console.log(Fields + "fields" + PassedArgs);
    var o = new LiveSpellInstance;
    console.log("instance created" + o);
...
function setup___livespell() {
  ...
  if (foundTag || (foundTag = tags[tags.length - 1]), "undefined" != typeof window.livespell___installPath) path = livespell___installPath; else try {
...
if ("undefined" == typeof JavaScriptSpellCheck || !JavaScriptSpellCheck) var JavaScriptSpellCheck = new JavaScriptSpellCheckObj,
  $Spelling = JavaScriptSpellCheck, $spelling = JavaScriptSpellCheck;
if ("undefined" == typeof livespell) {
  var livespell = {
    ...
    setrubberRingServerModel: function () {
      ...
      var mode = "";
      if (this.testSyncRequest(livespell.installPath + "core/Default.aspx")) mode = "aspx"; else if (this.testSyncRequest(livespell.installPath + "core/Default.ashx")) mode = "asp.net"; else if (this.testSyncRequest(livespell.installPath + "core/index.php")) mode = "php"; else {
    ...
    testSyncRequest: function (posturl) {
      ...
      if (posturl.indexOf("html") > -1) xhr.open("GET", posturl, !1), xhr.send(); else {
        var params = "test=true";
        xhr.open("GET", posturl + "?" + params, !1), xhr.send()
      }
      return 200 == xhr.status ? ("undefined" != typeof window.LIVESPELL_DEBUG_MODE && livespell.ajax.debug("SERVER ERROR:" + xhr.responseText, !1), "no command" == xhr.responseText.toLowerCase().replace(/^\s\s*/, "").replace(/\s\s*$/, "")) : ("undefined" != typeof window.LIVESPELL_DEBUG_MODE && livespell.ajax.debug("SERVER CANNOT WORK:" + xhr.responseText, !1),
        !1)
    },
    addJs: function (js) {
    ...
    heartbeat: function () {
      for (var id, DesiredActive = new Array, p = 0; p < livespell.spellingProviders.length; p++) {
        ...
        if (provider.AsYouTypeIsActive) for (var flist = provider.arrCleanFields(), f = 0; f < flist.length; f++) if (id = flist[f], DesiredActive = livespell.array.safepush(DesiredActive, id), "textarea" != document.getElementById(id).nodeName.toLowerCase() || document.getElementById(id + livespell.insitu._FIELDSUFFIX)) {
    ...
    getIframeDocumentBasic: function (myFrame) {
      ...
      if (myFrame.src.indexOf("fckeditor.html") > 0) {
        if (myFrame.contentWindow) oDoc = myFrame.contentWindow.frames[0].document; else {
          if (!myFrame.contentDocument) return null;
          oDoc = myFrame.frames[0].contentDocument
        }
        return oDoc
      }
      if (myFrame.contentWindow) oDoc = myFrame.contentWindow.document; else {
        if (!myFrame.contentDocument) return null;
    ...
    lang: {
      ...
      load: function (lang) {
        var idname = "__livespell__translations__" + lang, fileref = E$(idname);
    ...
    constants: {_IFRAME: "livespell___ajax_frame", _AJAXFORM: "livespell___ajax_form"},
    ajax: {
      renderIframe: function (postURL) {
        ...
        var oSender = livespell.spellingProviders[sender], serverModel = oSender.ServerModel.toLowerCase();
        "" !== livespell.rubberRingServerModel && (serverModel = livespell.rubberRingServerModel);
        var posturl = livespell.installPath + "core/";
        if ("asp.net" === serverModel) posturl += "default.ashx"; else if ("aspx" === serverModel) posturl += "Default.aspx"; else if ("asp" === serverModel) posturl += "default.asp"; else if ("php" === serverModel) posturl += "index.php"; else if ("auto" === serverModel || "" === serverModel) posturl += ""; else {
          if ("" === serverModel) throw"livespell::SeverModel not recognized: " + serverModel;
          posturl += "index." + serverModel
        }
        var settingsfile = livespell.spellingProviders[sender].SettingsFile, hasajax = !1, xhr = !1;
        ...
        if (params += "note=" + note, params += "&command=" + cmd, params += "&args=" + args, params += "&lan=" + lan, params += "&sender=" + sender, params += "&settingsfile=" + settingsfile, hasajax) {
          var liveSpellAjaxCallbackhandler = function () {
            if (4 == xhr.readyState) if (200 == xhr.status) livespell.ajax.pickup(xhr.responseText, !1); else if (livespell.rubberRingServerModel != livespell.setrubberRingServerModel() && livespell.ajax.resend(), "undefined" != typeof window.LIVESPELL_DEBUG_MODE) try {
        ...
        var settingsfile = livespell.spellingProviders[sender].SettingsFile, xhr = livespell.ajaxClient(!0);
      ...
      }, needsInstantSuggestion: !1, pickup: function (strHTML, binInstant) {
        ...
        var i, j, k, t, r, newSuggestions, sug_each_word, Suggestions, arrResult = strHTML.split(livespell.str.chr(5)),
          command = arrResult[0], vSender = Number(arrResult[1]), oSender = livespell.spellingProviders[vSender],
        ...
        if (livespell.cache.suggestions[vLang] || (livespell.cache.suggestions[vLang] = []), livespell.cache.spell[vLang] || (livespell.cache.spell[vLang] = []), livespell.cache.reason[vLang] || (livespell.cache.reason[vLang] = []), "CTXSPELL" === command) {
          ...
          for (newSuggestions = arrResult[2].split(livespell.str.chr(2)), livespell.cache.suggestions[vLang][livespell.cache.suggestionrequest.word] = newSuggestions, j = 0; j < newSuggestions.length; j++) for (livespell.cache.spell[vLang][newSuggestions[j]] = !0, sug_each_word = newSuggestions[j].replace(/\-/g, " ").split(" "), k = 0; k < sug_each_word.length; k++) livespell.cache.spell[vLang][sug_each_word[k]] = !0;
          ...
          if ("SAVEWORD" === command) {
            ...
            var Suggestion = arrResult[3], Origional = arrResult[2];
            ...
            var outInput = arrResult[4].split(livespell.str.chr(1)), isValid = "T" == arrResult[5], outSpellingOk = [],
              outReason = [];
            ...
            var doSuggest = arrResult[4].length > 0;
            Suggestions = arrResult[4].split(livespell.str.chr(1)), t = arrResult[2].split(""), r = arrResult[3].split(livespell.str.chr(1));
            var outInput = arrResult[5].split(livespell.str.chr(1)), outSpellingOk = [], outSuggestions = [],
              outReason = [];
    ...
    test: {
      HTML: function (str) {
        ...
        var FF3 = /firefox\/3./.test(navigator.userAgent.toLowerCase()),
          GK = /gecko/.test(navigator.userAgent.toLowerCase()), WIN = /windows/.test(navigator.userAgent.toLowerCase());
        return (FF3 || GK) && WIN
      }, MAC: function () {
        ...
        var wordSpellCheck = this.spelling(word, lang), result = wordSpellCheck === !0 || wordSpellCheck === !1;
      ...
      normalizeApos: function (tok) {
        ...
        if (livespell.test.IE5() || livespell.test.IE6() || livespell.test.IE7() || livespell.test.IE8()) {
          var EntityLevelHtmlDecode = function (input) {
            var e = document.createElement("span"), result = input.replace(/(&[^;]+;)+/g, function (match) {
        ...
        if (arrdoc[0] || arrdoc.shift(), arrdoc[arrdoc.length - 1] || arrdoc.pop(), !binraw) for (var i = 0; i < arrdocobj.length; i++) arrdoc[i] && (arrdoc[i] = livespell.str.normalizeApos(arrdoc[i]));
        return arrdoc
    ...
    userDict: {
      forget: function () {
        ...
        if (current_cookie.length) for (var arrPersonalWords = current_cookie.split(livespell.str.chr(1)), i = 0; i < arrPersonalWords.length; i++) livespell.cache.ignore[arrPersonalWords[i].toLowerCase()] && delete livespell.cache.ignore[arrPersonalWords[i].toLowerCase()]
      }, load: function () {
        var current_cookie = livespell.cookie.get("SPELL_DICT_USER");
        if (current_cookie.length) for (var arrPersonalWords = current_cookie.split(livespell.str.chr(1)), i = 0; i < arrPersonalWords.length; i++) livespell.cache.ignore[arrPersonalWords[i].toLowerCase()] = !0
      }, add: function (word) {
    ...
    events: {
      add: function (obj, event, callback, capture) {
        ...
        } else obj.attachEvent && (obj.detachEvent("on" + event, callback), obj.attachEvent("on" + event, callback))
      }
    },
    array: {
  ...
  Array.push || Array.prototype.push || (Array.prototype.push = function () {
    ...
    getProxyText: function (id) {
      var me = livespell.insitu.proxyDOM(id), val = livespell.insitu.extractTextWithWhitespace(me);
    ...
    setProxyHTMLAndMaintainCaretLegacy: function (id, val) {
      var dmilit = "\ufeff", liveField = livespell.insitu.proxyDOM(id), range = document.selection.createRange();
      range.pasteHTML(dmilit);
      var text = liveField.innerHTML;
      text = livespell.str.stripSpans(text);
      var pos = text.indexOf(dmilit), caretNode = document.getElementById("livespell_cursor_hack__" + id);
      ...
      var range = document.selection.createRange(), caretNode = document.getElementById("livespell_cursor_hack__" + id),
        id2 = id, n = function () {
      ...
      if ("" !== val && livespell.insitu.getProxyHTML(id) !== val) {
        ...
        if (window.getSelection) {
          ...
          var marker = livespell.str.chr(127) + livespell.str.chr(1) + livespell.str.chr(2),
            carretbuddyid = "_livespell__temp___273728", caretbuddy = "<span id='" + carretbuddyid + "'></span>",
          ...
          var carretbuddyid = "_livespell__temp___273728", caretbuddy = "<span id='" + carretbuddyid + "'></span>",
    ...
    checkNow: function (fieldList, providerID) {
      var txt = "";
      if (window.getSelection) txt = window.getSelection(); else if (document.getSelection) txt = document.getSelection(); else if (document.selection) try {
      ...
      if ("" == txt) {
        ...
        for (var mem_words = [], f = 0; f < fieldList.length; f++) {
          ...
          if ("textarea" == E$(id).nodeName.toLowerCase() || "input" == E$(id).nodeName.toLowerCase() && "text" == E$(id).type) {
            ...
            for (var strDoc = this.getProxyText(id), tokens = livespell.str.tokenize(strDoc), lng = this.provider(providerID).Language, memsize = 0, memmax = livespell.maxURI - 257, i = 0; i < tokens.length && memsize < memmax; i++) if (mem_words["_" + tokens[i]] !== !0 && livespell.test.isword(tokens[i]) === !0) {
        ...
        if (e && !e.disabled) {
          ...
          if (window.getComputedStyle) {
            ...
            for (i = 0; i < stylesToCopy.length; i++) {
              var attr = stylesToCopy[i], attr2 = stylesToSet[i], styleval = compStyle.getPropertyValue(attr);
            ...
            for (n.oneline || (n.style.overflowY = "scroll"), i = 0; i < stylesToCopy.length; i++) if (attr = stylesToSet[i], styleval = t.currentStyle[attr]) try {
              if ("width" == attr) {
                try {
          ...
          livespell.events.add(n, "keypress", livespell.insitu.keypresshandler, !0), livespell.events.add(n, "keydown", livespell.insitu.keyhandler, !1), livespell.events.add(n, "blur", livespell.insitu.blurhandler, !1), livespell.events.add(n, "focus", livespell.insitu.focushandler, !1), n.unChanged = !0, livespell.test.IE() && ((livespell.test.IE7() || livespell.test.IE6()) && (n.onblur = function () {
            ...
            var marker = "\0\ufeff", carretbuddyid = "_livespell__temp___273728",
              caretbuddy = "<span id='" + carretbuddyid + "'>|</span>", sel = window.getSelection();
            if (sel.getRangeAt && sel.rangeCount) {
              ...
              var ff_onafterpaste = function () {
                var newContent = n.textContent, caretNode = document.getElementById(carretbuddyid);
          ...
          var trueparent = t.parentNode, truesib = t;
          if (livespell.test.IE()) for (; "P" == trueparent.nodeName || "H1" == trueparent.nodeName || "H2" == trueparent.nodeName || "H3" == trueparent.nodeName || "H4" == trueparent.nodeName || "H5" == trueparent.nodeName || "H6" == trueparent.nodeName;) truesib = trueparent, trueparent = trueparent.parentNode;
          ...
          if (o.hasFocus = !1, livespell.events.add(o, "focus", function () {
            ...
            o.hasFocus = !1
          }, !1), livespell.liveProxys = livespell.array.safepush(livespell.liveProxys, id), this.setProxyText(id, E$(id).value), t.readOnly) livespell.test.IE() && (n.style.display = "inline-block"); else {
    ...
    cloneClientEventsHelper: function (from, to, sevent) {
      var element = from, proxy = to, event = sevent, fn = function () {
    ...
    maxCharsHandler: function (event) {
      var obj = event.srcElement ? event.srcElement : this, maxChars = obj.maxLength;
      ...
      if (numChars >= maxChars) {
        ...
        var ch8r = event.keyCode, hasRange = !1, txt = "";
        try {
    ...
    strictMaxChars: function (obj) {
      var base_field_id = obj.id.split(livespell.insitu._FIELDSUFFIX)[0],
        text = livespell.insitu.getProxyText(base_field_id), numChars = text.length;
    ...
    keyhandler: function (event) {
      ...
      if (!(ch8r >= 16 && ch8r <= 31 || ch8r >= 37 && ch8r <= 40)) {
        ...
        if (livespell.insitu.ignoreAtCursor(), me.unChanged = !1, me.hasFocus = !0, me.autocheck) {
          ...
          var ProviderId = Number(me.autocheckProvider), oProvider = livespell.spellingProviders[ProviderId];
    ...
    mouseoverme: !1, caller: null, callerParent: null, keysTrapped: !1, providerID: null, mackeydown: function (event) {
      try {
        event || (event = window.event)
      } catch (e) {
      }
      ...
      if (oF && oF.MessageHolder) {
        ...
        if (proxy) {
          var wiggles = proxy.getElementsByTagName("SPAN"), isValid = !0;
    ...
    }, langInSelection: !1, hideIfNotinUse: function () {
      ...
      var event = "change", element = oBase;
      ...
      var b = this.base_field_id(), basefield = E$(b + livespell.insitu._FIELDSUFFIX);
      try {
        ...
        livespell.context.caller.innerHTML = word, livespell.context.caller.onMouseUp = function () {
      ...
      var b = this.base_field_id(), p = livespell.context.caller, pp = p.parentNode;
      ...
      if (this.provider().Language != strLang) {
        ...
        var tProv = this.provider(), fn = function () {
          tProv.CheckInSitu()
        };
      ...
      switch (reason) {
        ...
        default:
          ...
          if (2 === oCase) for (j = 0; j < suggs.length; j++) suggs[j] = suggs[j].toUpperCase(); else if (1 === oCase) for (j = 0; j < suggs.length; j++) suggs[j] = livespell.str.toCaps(suggs[j])
      }
      ...
      var oscreen = this.DimViewport(), ws = oscreen.width, hs = oscreen.height,
      ...
      var dmenu = this.DimMenu(), wm = dmenu.width, hm = dmenu.height;
      if (hm + py - scrolly > hs) {
